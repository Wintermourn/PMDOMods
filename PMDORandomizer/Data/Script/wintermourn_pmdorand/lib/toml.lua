...
- with changes from https://github.com/jonstoler/lua-toml/pull/23
...
--- wintermourn edit (code from http://lua-users.org/wiki/CopyTable)
-- i didn't like it nuking my tables

-- basically the end of edit

TOML.encode = function(tbl)
	local toml = ""
	tbl = require 'wintermourn_pmdorand.lib.deepcopy' .deepcopy(tbl)
